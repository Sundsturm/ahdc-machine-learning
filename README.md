...
## Contributor
| Full Name            | NIM      | Field          | Responsibility |
| -------- | -------- | -------- | -------- |
| Kean Malik Aji Santoso    | 13222083     | Electrical Engineering     | Artificial Intelligence for Arrhythmia Detection & Classification |
...
Each learning/training session follows the pipeline shown in the image below. This pipeline is a rough overview of the machine learning process.

![PipelineML](https://hackmd.io/_uploads/H14NRFhKgx.png)

In addition to the pipeline, the results of the artificial intelligence training can be determined based on specific metrics. The primary metrics for this training are:
